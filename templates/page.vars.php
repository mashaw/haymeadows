...
function connectingnature_preprocess_page(&$variables) {
...
if (!empty($variables['page']['sidebar_first']) || !empty($variables['page']['sidebar_second'])) {
    $variables['header_class'] = ' class="sidebars"';

  }

  else {
    $variables['header_class'] = ' class="no-sidebars"';
  }
 ...
 */
function connectingnature_process_page(&$variables) {
